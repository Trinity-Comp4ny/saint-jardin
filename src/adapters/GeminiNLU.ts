...
- visita: SÓ quando o estado for "aguardando_pref_visita" (a noiva está dizendo que dia prefere para a visita ao espaço). Preencha:
  ...
  - visita.dataHora: preencha sempre que ela der um HORÁRIO COM NÚMERO ("às 14h", "10h", "16:30", "10 da manhã") OU uma data concreta ("dia 12", "15 de agosto", "sábado que vem") — mesmo que o dia seja só o NOME do dia da semana, não uma data de calendário (ex.: "domingo às 14h" -> dataHora "domingo às 14h", NÃO vire diaSemana+periodo). Copie em texto curto e natural o que ela pediu (ex.: "dia 12 às 10h", "domingo às 14h"). Deixe null (usando diaSemana/periodo em vez disso) SÓ quando a preferência for vaga, sem nenhum número de horário nem data (ex.: "domingo de manhã", "de tarde", "qualquer dia").
